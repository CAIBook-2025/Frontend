    ...
    <main className="container mx-auto px-6 py-8">
      ...
      <div className="mb-6 flex flex-wrap gap-3">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
            filterStatus === 'finished' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
          }`}
        >
          Finalizados
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium transition-colors ${
            filterStatus === 'cancelled' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
          }`}
        >
          Cancelados
        </button>
            ...
            >
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <h3 className="text-xl font-bold text-gray-900 flex-1 mr-2">{event.name}</h3>
                ...
                <div className="mt-4 pt-4 border-t">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-semibold text-gray-900">{event.public_space.capacity} personas</span>
                  </div>
                </div>
              </div>
            </div>
