    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative w-full max-w-md rounded-lg bg-white p-6 shadow-xl transform transition-all">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">¿Levantar suspensión?</h3>
          ...
          <div className="mt-2">
            ...
            <p className="text-sm text-gray-500 mt-2">
              Esta acción <span className="font-bold text-red-600">eliminará permanentemente</span> todos los strikes
              asociados a este usuario y no se puede deshacer.
            </p>
          </div>
        </div>
