...
import { Users, Building2, AlertTriangle, UserCog } from 'lucide-react';
    ...
    <div className={`w-full rounded-xl border border-gray-200 p-6 shadow-sm`}>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Link href="/Admin/Users" className="w-full">
          <button className="flex w-full items-center rounded-lg bg-purple-500 px-4 py-2 text-white transition-colors hover:bg-purple-600">
